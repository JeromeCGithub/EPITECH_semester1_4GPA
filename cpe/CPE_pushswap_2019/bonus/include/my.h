...
void loop_final(sfRenderWindow *, sfRenderWindow *);
void display_list(linked_list_t *);
void update_screen(linked_list_t **, sfRenderWindow *, sfRenderWindow *);
...
int radix_s(int ac, char **av, sfRenderWindow *, sfRenderWindow *);
